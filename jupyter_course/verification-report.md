...
|---:|---|---:|---:|---:|---|
| 00 | `00_시작하기.ipynb` | 4 | 18 | 1.68초 | PASS |
| 01 | `01_NEIS_API와_JSON.ipynb` | 6 | 24 | 1.33초 | PASS |
| 02 | `02_급식데이터_정리와_그래프.ipynb` | 5 | 21 | 1.52초 | PASS |
| 03 | `03_TFIDF_글자를_숫자로.ipynb` | 6 | 24 | 1.27초 | PASS |
| 04 | `04_유사도와_식단군집.ipynb` | 4 | 18 | 1.25초 | PASS |
| 05 | `05_개인추천_점수설계.ipynb` | 4 | 18 | 1.28초 | PASS |
| 06 | `06_Jupyter_추천화면.ipynb` | 5 | 21 | 1.49초 | PASS |
| 07 | `07_테스트와_모델카드.ipynb` | 4 | 18 | 1.33초 | PASS |
| 08 | `08_발표와_체험.ipynb` | 4 | 18 | 1.05초 | PASS |
...
- n-gram 경계 조각, 흔한·드문 조각의 IDF 차이, 군집, 추천 결과의 필수 값
